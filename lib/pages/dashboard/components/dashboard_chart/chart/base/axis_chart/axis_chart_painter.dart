...
import 'package:huddlelabs/pages/dashboard/components/dashboard_chart/chart/bar_chart/bar_chart_painter.dart';
import 'package:huddlelabs/pages/dashboard/components/dashboard_chart/chart/base/base_chart/base_chart_painter.dart';
import 'package:huddlelabs/pages/dashboard/components/dashboard_chart/extensions/canvas_extension.dart';
      ...
      while (verticalSeek <= data.maxX - data.gridData.verticalInterval) {
        if (data.gridData.checkToShowVerticalLine(verticalSeek)) {
          ...
          canvas.drawDashedLine(
              Offset(x1, y1), Offset(x2, y2), gridPaint, flLineStyle.dashArray);
        }
    ...
    if (data.gridData.drawHorizontalLine) {
      ...
      while (horizontalSeek <= data.maxY - data.gridData.horizontalInterval) {
        if (data.gridData.checkToShowHorizontalLine(horizontalSeek)) {
          ...
          canvas.drawDashedLine(
              Offset(x1, y1), Offset(x2, y2), gridPaint, flLine.dashArray);
        }
